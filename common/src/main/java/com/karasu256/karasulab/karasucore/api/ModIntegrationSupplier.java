...
import com.karasu256.karasulab.karasucore.exception.IntegrationException;
...
public class ModIntegrationSupplier<T extends IModIntegration> implements Supplier<T> {
    ...
    public T get() {
        try {
            ...
            throw new IntegrationException("Failed to instantiate integration class: " + className, e);
        }
    }
}
